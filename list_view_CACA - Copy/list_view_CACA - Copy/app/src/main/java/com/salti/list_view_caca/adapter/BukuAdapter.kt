...
import com.salti.list_view_caca.model.ModelBuku
...
class BukuAdapter (private val buku: List<ModelBuku>) :
    ...
    class BukuAdapterHolder(view: View) : RecyclerView.ViewHolder(view) {
        val txtJudul: TextView = view.findViewById(R.id.txtJudul1)
        val txtPenulis: TextView = view.findViewById(R.id.txtPenulis1)
    }
